...
* @public
 */
export declare class STokMintDelegateDataBridge extends ContractDataBridge {
    ...
    reader: STokMintDelegateDataBridgeReader;
    /**
...
export default STokMintDelegateDataBridge;
/**
 * @public
 */
export declare class STokMintDelegateDataBridgeReader extends DataBridgeReaderClass {
    bridge: STokMintDelegateDataBridge;
    constructor(bridge: STokMintDelegateDataBridge, isMainnet: boolean);
...
export declare class MintingActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
     ...
     * `mkTxnCreateRecord({activity, ...})` method.
     */
    get $seeded$MintingParticipantToken(): import("@donecollectively/stellar-contracts").SeedActivity<(thingWithSeed: hasSeed | TxOutputId | string) => UplcData>;
    /**
...
export declare class MintingActivityHelperNested extends EnumBridge<isActivity> {
    ...
    * a complete wrapper for this inner activity detail.
     */
    get $seeded$MintingParticipantToken(): import("@donecollectively/stellar-contracts").SeedActivity<(thingWithSeed: hasSeed | TxOutputId | string) => isActivity>;
    /**
...
//# sourceMappingURL=STokMintDelegate.bridge.d.ts.map