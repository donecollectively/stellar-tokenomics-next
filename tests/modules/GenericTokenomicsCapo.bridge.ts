...
} from "./GenericTokenomicsCapo.typeInfo.js";

export type * as types from "./GenericTokenomicsCapo.typeInfo.js";
import type * as types from "./GenericTokenomicsCapo.typeInfo.js";



/**
 * GENERATED data bridge for **Capo** script (defined in class ***GenericTokenomicsCapoBundle***)
...
export class GenericTokenomicsCapoBridge extends ContractDataBridge {
    ...
    reader = new GenericTokenomicsCapoBridgeReader(this, this.isMainnet);
...
export class GenericTokenomicsCapoBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: GenericTokenomicsCapoBridge, isMainnet: boolean) {
        super();
    }
    /**
