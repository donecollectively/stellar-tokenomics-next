...
import type {
    ...
    SaleProgressDetails, ErgoSaleProgressDetails, SaleProgressDetailsLike,
    MarketSaleState, ErgoMarketSaleState, MarketSaleStateLike,
    OtherSaleState, ErgoOtherSaleState, OtherSaleStateLike,
    ...
    FixedSaleDetails, ErgoFixedSaleDetails, FixedSaleDetailsLike,
    SaleAssets, ErgoSaleAssets, SaleAssetsLike,
    ThreadInfo, ErgoThreadInfo, ThreadInfoLike,
    MoreFields, ErgoMoreFields, MoreFieldsLike,
    MarketSaleData, ErgoMarketSaleData, MarketSaleDataLike,
    ...
    SpendingActivity$AddingToSale, SpendingActivity$Ergo$AddingToSale, SpendingActivity$AddingToSaleLike,
    SpendingActivity$SellingTokens, SpendingActivity$Ergo$SellingTokens, SpendingActivity$SellingTokensLike,
    SpendingActivity$MergingChildChunk, SpendingActivity$Ergo$MergingChildChunk, SpendingActivity$MergingChildChunkLike,
    SpendingActivity, ErgoSpendingActivity, SpendingActivityLike,
    MintingActivity$SplittingSaleChunkAndBuying, MintingActivity$Ergo$SplittingSaleChunkAndBuying, MintingActivity$SplittingSaleChunkAndBuyingLike,
    MintingActivity, ErgoMintingActivity, MintingActivityLike,
    BurningActivity$JoiningWithParentChunk, BurningActivity$Ergo$JoiningWithParentChunk, BurningActivity$JoiningWithParentChunkLike,
    ...
    DTS_PurchaseInfo, ErgoDTS_PurchaseInfo, DTS_PurchaseInfoLike,
    DynamicSaleV1, ErgoDynamicSaleV1, DynamicSaleV1Like
} from "./MarketSale.concrete.typeInfo.js";

export type * as types from "./MarketSale.concrete.typeInfo.js";
import type * as types from "./MarketSale.concrete.typeInfo.js";
...
export class MarketSalePolicyDataBridge extends ContractDataBridge {
    ...
    progressDetails: /*minStructField*/ SaleProgressDetailsLike
    ...
    saleState: /*minStructField*/ OtherSaleStateLike
    fixedSaleDetails: /*minStructField*/ FixedSaleDetailsLike
    saleAssets: /*minStructField*/ SaleAssetsLike
    threadInfo: /*minStructField*/ ThreadInfoLike
}
) => {
    ...
    moreFields: /*minStructField*/ MoreFieldsLike
}
) => {
    ...
    totalProgress: /*minStructField*/ SaleProgressDetailsLike
}
) => {
    ...
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺSaleProgressDetailsCast = makeCast<SaleProgressDetails, SaleProgressDetailsLike>(
        SaleProgressDetailsSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺOtherSaleStateCast = makeCast<OtherSaleState, OtherSaleStateLike>(
        OtherSaleStateSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺDynamicSaleV1SettingsCast = makeCast<DynamicSaleV1Settings, DynamicSaleV1SettingsLike>(
    ...
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺFixedSaleDetailsCast = makeCast<FixedSaleDetails, FixedSaleDetailsLike>(
        FixedSaleDetailsSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺSaleAssetsCast = makeCast<SaleAssets, SaleAssetsLike>(
        SaleAssetsSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺThreadInfoCast = makeCast<ThreadInfo, ThreadInfoLike>(
        ThreadInfoSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺMoreFieldsCast = makeCast<MoreFields, MoreFieldsLike>(
        MoreFieldsSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺMarketSaleDataCast = makeCast<MarketSaleData, MarketSaleDataLike>(
    ...
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺDTS_PurchaseInfoCast = makeCast<DTS_PurchaseInfo, DTS_PurchaseInfoLike>(
        DTS_PurchaseInfoSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺDynamicSaleV1Cast = makeCast<DynamicSaleV1, DynamicSaleV1Like>(
        DynamicSaleV1Schema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
...
export class MarketSalePolicyDataBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: MarketSalePolicyDataBridge, isMainnet: boolean) {
        super();
    }
    /**
...
datum = (d: UplcData) => { return this.DelegateDatum(d) }
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    SaleProgressDetails(d: UplcData) {
        const cast = this.bridge.ᱺᱺSaleProgressDetailsCast;
        return cast.fromUplcData(d) //??? as ErgoSaleProgressDetails;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    OtherSaleState(d: UplcData) {
        const cast = this.bridge.ᱺᱺOtherSaleStateCast;
        return cast.fromUplcData(d) //??? as ErgoOtherSaleState;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    DynamicSaleV1Settings(d: UplcData) {
        const cast = this.bridge.ᱺᱺDynamicSaleV1SettingsCast;
        return cast.fromUplcData(d) //??? as ErgoDynamicSaleV1Settings;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    FixedSaleDetails(d: UplcData) {
        const cast = this.bridge.ᱺᱺFixedSaleDetailsCast;
        return cast.fromUplcData(d) //??? as ErgoFixedSaleDetails;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    SaleAssets(d: UplcData) {
        const cast = this.bridge.ᱺᱺSaleAssetsCast;
        return cast.fromUplcData(d) //??? as ErgoSaleAssets;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    ThreadInfo(d: UplcData) {
        const cast = this.bridge.ᱺᱺThreadInfoCast;
        return cast.fromUplcData(d) //??? as ErgoThreadInfo;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    MoreFields(d: UplcData) {
        const cast = this.bridge.ᱺᱺMoreFieldsCast;
        return cast.fromUplcData(d) //??? as ErgoMoreFields;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    MarketSaleData(d: UplcData) {
        const cast = this.bridge.ᱺᱺMarketSaleDataCast;
        return cast.fromUplcData(d) //??? as ErgoMarketSaleData;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    DTS_PurchaseInfo(d: UplcData) {
        const cast = this.bridge.ᱺᱺDTS_PurchaseInfoCast;
        return cast.fromUplcData(d) //??? as ErgoDTS_PurchaseInfo;
    } /* structReader helper */
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    DynamicSaleV1(d: UplcData) {
        const cast = this.bridge.ᱺᱺDynamicSaleV1Cast;
        return cast.fromUplcData(d) //??? as ErgoDynamicSaleV1;
    } /* structReader helper */
...
/**
 * Helper class for generating UplcData for the struct ***SaleProgressDetails*** type.
 * @public
 */
export class SaleProgressDetailsHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<SaleProgressDetails, SaleProgressDetailsLike>(
        SaleProgressDetailsSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
export class MarketSaleStateHelper extends EnumBridge<JustAnEnum> {
    /*mkEnumHelperClass*/
    /**
            * @internal
            *  uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<MarketSaleState, MarketSaleStateLike>(
 ...
 */
    get Pending() {
        const uplc = this.mkUplcData({ Pending: {} }, 
...
/**
 * Helper class for generating UplcData for the struct ***OtherSaleState*** type.
 * @public
 */
export class OtherSaleStateHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<OtherSaleState, OtherSaleStateLike>(
        OtherSaleStateSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
 ...
 * @public
 */
export class DynamicSaleV1SettingsHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<DynamicSaleV1Settings, DynamicSaleV1SettingsLike>(
        DynamicSaleV1SettingsSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
/**
 * Helper class for generating UplcData for the struct ***FixedSaleDetails*** type.
 * @public
 */
export class FixedSaleDetailsHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<FixedSaleDetails, FixedSaleDetailsLike>(
        FixedSaleDetailsSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
/**
 * Helper class for generating UplcData for the struct ***SaleAssets*** type.
 * @public
 */
export class SaleAssetsHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<SaleAssets, SaleAssetsLike>(
        SaleAssetsSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
/**
 * Helper class for generating UplcData for the struct ***ThreadInfo*** type.
 * @public
 */
export class ThreadInfoHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<ThreadInfo, ThreadInfoLike>(
        ThreadInfoSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
/**
 * Helper class for generating UplcData for the struct ***MoreFields*** type.
 * @public
 */
export class MoreFieldsHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<MoreFields, MoreFieldsLike>(
        MoreFieldsSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
 ...
 * @public
 */
export class MarketSaleDataHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<MarketSaleData, MarketSaleDataLike>(
        MarketSaleDataSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
export class DelegateDatumHelper extends EnumBridge<JustAnEnum> {
    ...
    tn: /*minStructField*/ number[]
        ...
        const uplc = this.mkUplcData({ 
           IsDelegation: dd
        }, "MarketSalePolicy::DelegateDatum.IsDelegation"); /*singleField enum variant*/
        return makeInlineTxOutputDatum(uplc);
    }
...
export class SpendingActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    UpdatingRecord(
        ...
        const uplc = this.mkUplcData({ 
           UpdatingRecord: id
        }, "MarketSalePolicy::SpendingActivity.UpdatingRecord"); /*singleField enum variant*/
       return uplc;
    }
    ...
    Activating(
        ...
        const uplc = this.mkUplcData({ 
           Activating: id
        }, "MarketSalePolicy::SpendingActivity.Activating"); /*singleField enum variant*/
       return uplc;
    }
    ...
    SplittingSaleChunkAndBuying(
        ...
        if (filteredFields) {
           ...
           return uplc;
            ...
            const fields = seedOrUf as MintingActivity$SplittingSaleChunkAndBuyingLike; 
           const uplc = this.mkUplcData({
...
export class BurningActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    DeletingRecord(
        ...
        const uplc = this.mkUplcData({ 
           DeletingRecord: id
        }, "MarketSalePolicy::BurningActivity.DeletingRecord"); /*singleField enum variant*/
       return uplc;
    }
    ...
    CleanupRetired(
        ...
        const uplc = this.mkUplcData({ 
           CleanupRetired: id
        }, "MarketSalePolicy::BurningActivity.CleanupRetired"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
...
export class DelegateActivityHelper extends EnumBridge<isActivity> {
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
    ...
    MultipleDelegateActivities(
        ...
        }, "MarketSalePolicy::DelegateActivity.MultipleDelegateActivities"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
 ...
 * @public
 */
export class DTS_PurchaseInfoHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<DTS_PurchaseInfo, DTS_PurchaseInfoLike>(
        DTS_PurchaseInfoSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
 ...
 * @public
 */
export class DynamicSaleV1Helper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<DynamicSaleV1, DynamicSaleV1Like>(
        DynamicSaleV1Schema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
export const SaleProgressDetailsSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const MarketSaleStateSchema : EnumTypeSchema = {
    "kind": "enum",
...
export const OtherSaleStateSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const FixedSaleDetailsSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const SaleAssetsSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const ThreadInfoSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const MoreFieldsSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const MarketSaleDataSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "map",
...
export const DTS_PurchaseInfoSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
...
export const DynamicSaleV1Schema : StructTypeSchema = {
    "kind": "struct",
    "format": "list",
