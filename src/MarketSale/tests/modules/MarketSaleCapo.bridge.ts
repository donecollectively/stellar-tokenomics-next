...
} from "./MarketSaleCapo.typeInfo.js";

export type * as types from "./MarketSaleCapo.typeInfo.js";
import type * as types from "./MarketSaleCapo.typeInfo.js";



/**
 * GENERATED data bridge for **Capo** script (defined in class ***MarketSaleCapoBundle***)
...
* @public
 */
export class MarketSaleCapoBridge extends ContractDataBridge {
    ...
    reader = new MarketSaleCapoBridgeReader(this, this.isMainnet);
...
export default MarketSaleCapoBridge;

/**
 * @public
 */
export class MarketSaleCapoBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: MarketSaleCapoBridge, isMainnet: boolean) {
        super();
    }
    /**
...
export class CapoActivityHelper extends EnumBridge<isActivity> {
    ...
    get capoLifecycleActivity() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "CapoHelpers::CapoActivity.capoLifecycleActivity" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
