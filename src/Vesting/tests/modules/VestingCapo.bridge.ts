...
} from "./VestingCapo.typeInfo.js";

export type * as types from "./VestingCapo.typeInfo.js";
import type * as types from "./VestingCapo.typeInfo.js";



/**
 * GENERATED data bridge for **Capo** script (defined in class ***VestingCapoBundle***)
...
* @public
 */
export class VestingCapoBridge extends ContractDataBridge {
    ...
    reader = new VestingCapoBridgeReader(this, this.isMainnet);
...
export default VestingCapoBridge;

/**
 * @public
 */
export class VestingCapoBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: VestingCapoBridge, isMainnet: boolean) {
        super();
    }
    /**
