...
#### Remaining items
- Helper method source for Stop/Resume/Retire (dedicated builders vs `mkTxnUpdateRecord`) — TODO comments in helpers are placeholders; coder adapts to whatever off-chain coder delivers
- Self-audit against patterns JSONL and essential guide — pending after all design decisions settle
- Interview not yet complete
